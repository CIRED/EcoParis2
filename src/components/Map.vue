...
<script>
//import displayMap from '../map_generate_voronoi' // ======= here! ======= 
import displayMap from '../map_check_voronoi' 
...
export default {
   ...
   */
  mounted () {
    var urlDepartment = 'data/intercommunalites.geojson' // ======= here! ======= 
    var urlVoronoi = 'data/voronois.json' // ======= here! ======= 
